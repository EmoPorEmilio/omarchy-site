...
export const Route = createFileRoute('/explorations/first-pass')({
  head: () => ({
    meta: [
      {
        title: 'Omarchy — First-pass exploration',
      },
    ],
    links: [{ rel: 'stylesheet', href: appCss }],
  }),
  component: FirstPassExploration,
})
